...
export default class Subscriptions extends React.Component<any, any> {
    ...
    componentDidMount =  async () =>{
        ...
        // let fetchSubscribedItemsAPI = 'https://api.myjson.com/bins/ebv74'
        
        // if(RandomNumber>-1){
        //      fetchSubscribedItemsAPI = 'https://api.myjson.com/bins/8fob4'
        // }
        // console.log(RandomNumber)
        // const response = await fetch(fetchSubscribedItemsAPI);
        // const fetched = await response.json()
        // this.subscribedItems = await fetched.subs
         this.isLoaded = true
    }
